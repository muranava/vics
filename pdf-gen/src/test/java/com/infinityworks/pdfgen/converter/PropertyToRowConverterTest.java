...
public class PropertyToRowConverterTest {
    ...
    public void convertsAPropertyToATableRow() throws Exception {
        ...
        assertThat(electorRows.get(0).getStreet(), is("Highland Close, Glen Avenue, Amber, CV2 3ER"));
        ...
        assertThat(electorRows.get(1).getStreet(), is("Highland Close, Glen Avenue, Amber, CV2 3ER"));
        ...
        assertThat(electorRows.get(2).getStreet(), is("Highland Close, Glen Avenue, Amber, CV2 3ER"));
