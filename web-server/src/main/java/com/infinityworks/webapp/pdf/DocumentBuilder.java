...
public class DocumentBuilder {
    ...
    public DocumentBuilder(LogoRenderer logoRenderer, FlagsKeyRenderer flagsKeyRenderer, PdfTableConfig tableConfig) {
     ...
     */
    public ByteArrayOutputStream buildPages(List<GeneratedPdfTable> pdfTables, Flags flags) {
