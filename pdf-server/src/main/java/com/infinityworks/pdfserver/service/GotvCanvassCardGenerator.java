 ...
 */
@Service
public class GotvCanvassCardGenerator extends CanvassCardGeneratorTemplate {
    private final Logger log = LoggerFactory.getLogger(GotvCanvassCardGenerator.class);
    private final GotvRequestAdapter gotvRequestAdapter;

    @Autowired
    public GotvCanvassCardGenerator(@Qualifier("gotv") TableBuilder tableBuilder,
